...
Command: npx gltfjsx@6.5.3 public/models/Animated Woman.glb -o src/Components/3D/Women.jsx -r public 
*/
      ...
      <group name="Root_Scene">
        <group name="RootNode">
          ...
          <group name="Casual_Body" rotation={[-Math.PI / 2, 0, 0]} scale={100}>
            ...
            >
              <meshBasicMaterial color={topColor}></meshBasicMaterial>
            </skinnedMesh>
            <skinnedMesh
              name="Casual_Body_2"
          ...
          <group name="Casual_Head" rotation={[-Math.PI / 2, 0, 0]} scale={100}>
            ...
            >
              <meshBasicMaterial color={hairColor}></meshBasicMaterial>
            </skinnedMesh>
            <skinnedMesh
              name="Casual_Head_3"
          ...
          <skinnedMesh
            ...
            scale={100}
          >
            <meshBasicMaterial color={bottomColor}></meshBasicMaterial>
          </skinnedMesh>
        </group>
      </group>
    </group>
